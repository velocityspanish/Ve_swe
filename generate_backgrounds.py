...
# HIGH CONTRAST gradients for ALL 25 categories (Swedish names)
category_colors = {
    'Motivation': [(138, 43, 226), (75, 0, 130), (255, 20, 147), (147, 112, 219)],  # Purple → Pink
    'Kärlek': [(255, 0, 100), (139, 0, 0), (255, 105, 180), (255, 192, 203)],  # Red → Pink
    'Framgång': [(255, 215, 0), (0, 100, 0), (255, 140, 0), (34, 139, 34)],  # Gold → Green
    'Visdom': [(0, 0, 139), (255, 215, 0), (70, 130, 180), (255, 255, 0)],  # Blue → Yellow
    'Lycka': [(255, 255, 0), (255, 0, 255), (255, 165, 0), (147, 112, 219)],  # Yellow → Purple
    'Självutveckling': [(0, 128, 0), (255, 215, 0), (0, 255, 0), (255, 140, 0)],  # Green → Gold
    'Tacksamhet': [(255, 127, 80), (75, 0, 130), (255, 160, 122), (138, 43, 226)],  # Coral → Purple
    'Vänskap': [(255, 192, 203), (0, 100, 80), (255, 105, 180), (0, 200, 160)],  # Pink → Teal
    'Hopp': [(0, 0, 100), (255, 255, 0), (70, 130, 180), (255, 215, 0)],  # Blue → Yellow
    'Kreativitet': [(255, 0, 127), (0, 0, 139), (255, 20, 147), (75, 0, 130)],  # Pink → Blue
    'Inre Frid': [(135, 206, 235), (0, 0, 100), (176, 224, 230), (75, 0, 130)],  # Blue → Purple
    'Självförtroende': [(255, 69, 0), (0, 0, 139), (255, 140, 0), (70, 130, 180)],  # Orange → Blue
    'Uthållighet': [(139, 69, 19), (255, 215, 0), (160, 82, 45), (255, 140, 0)],  # Brown → Gold
    ...
    'Vänlighet': [(255, 182, 193), (138, 43, 226), (255, 160, 122), (75, 0, 130)],  # Pink → Purple
    'Tålamod': [(34, 139, 34), (255, 255, 0), (60, 179, 113), (255, 215, 0)],  # Green → Yellow
    'Förlåtelse': [(230, 230, 250), (75, 0, 130), (216, 191, 216), (138, 43, 226)],  # Lavender → Purple
    'Styrka': [(100, 100, 100), (255, 69, 0), (150, 150, 150), (255, 140, 0)],  # Gray → Orange
    'Glädje': [(255, 255, 0), (255, 0, 127), (255, 215, 0), (147, 112, 219)],  # Yellow → Purple
    'Balans': [(60, 179, 113), (138, 43, 226), (152, 251, 152), (75, 0, 130)],  # Green → Purple
    'Tillväxt': [(0, 100, 0), (255, 215, 0), (34, 139, 34), (255, 140, 0)],  # Green → Gold
    'Syfte': [(75, 0, 130), (255, 215, 0), (138, 43, 226), (255, 140, 0)],  # Purple → Gold
    'Mindfulness': [(210, 180, 140), (75, 0, 130), (245, 245, 220), (138, 43, 226)],  # Tan → Purple
}

all_categories = [
    'Motivation', 'Kärlek', 'Framgång', 'Visdom', 'Lycka',
    'Självutveckling', 'Tacksamhet', 'Vänskap', 'Hopp', 'Kreativitet',
    'Inre Frid', 'Självförtroende', 'Uthållighet', 'Inspiration', 'Positivt Liv',
    'Mod', 'Vänlighet', 'Tålamod', 'Förlåtelse', 'Styrka',
    'Glädje', 'Balans', 'Tillväxt', 'Syfte', 'Mindfulness'
]
