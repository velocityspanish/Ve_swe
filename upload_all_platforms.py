"""
Velocity Swedish - Unified Social Media Upload Script
...
def get_latest_reel():
    ...
    return {
        ...
        "metadata": metadata,
        "category": metadata.get("category_swedish", "Swedish Learning"),
...
def generate_caption(phrases, category, platform="facebook"):
    ...
    if platform == "facebook":
        ...
        caption_lines = [
            f"🇸🇪 Learn Swedish with Velocity Swedish! 🇸🇪",
            f"",
            f"📚 Category: {category}",
            f"",
            f"🎯 Master Swedish one phrase at a time! Today's {category} lesson:",
            f""
        ]
        ...
        for i, phrase in enumerate(phrases[:5], 0):
            ...
            caption_lines.append(f"   📍 {phrase['swedish']}")
        ...
        caption_lines.extend([
            ...
            f"🔔 Follow for daily Swedish lessons!",
            f"",
...
def upload_to_all_platforms(video_path, caption, category):
    ...
    print("\n" + "="*80)
    print("🚀 VELOCITY SWEDISH - MULTI-PLATFORM UPLOAD")
    print("="*80)
...
def main():
    ...
    print("\n" + "="*80)
    print("🇸🇪 VELOCITY SWEDISH - AUTOMATED UPLOAD 🇸🇪")
    print("="*80)
